# -*- coding: utf-8 -*-
"""
Created on Wed Jan 17 19:20:55 2024

@author: KGP
"""

# Plantilla de Regresión General
...
# Ajustar la regresión lineal con el dataset. Este es un caso muy concreto, así que tendremos que adapatar al tipo de regresión que sea
from sklearn.linear_model import LinearRegression
lin_reg = LinearRegression()
lin_reg.fit(x, y)

# Ajustar la regresión polinómica con el dataset. Este es un caso muy concreto, así que tendremos que adapatar al tipo de regresión que sea
...
# Visualización de los resultados del modelo lineal. Caso lineal
